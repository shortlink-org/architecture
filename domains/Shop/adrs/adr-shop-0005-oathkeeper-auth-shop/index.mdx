---
id: adr-shop-0005-oathkeeper-auth-shop
name: "ADR-0005 (shop): Shop authentication via Oathkeeper (JWT, identity propagation)"
version: 1.0.0
summary: "GraphQL BFF must receive authenticated user context (e.g."
status: accepted
date: 2026-02-04
owners:
  - shop-platform
...
x-source:
  ...
  path: docs/ADR/decisions/0005-oathkeeper-auth-shop.md
  sha256: 95fc22d238f5492df0db705ae984869e2fcbed27eec24c6a8b5857f4b24452ff
---

> Source: [docs/ADR/decisions/0005-oathkeeper-auth-shop.md](https://github.com/shortlink-org/shop/blob/main/docs/ADR/decisions/0005-oathkeeper-auth-shop.md)
