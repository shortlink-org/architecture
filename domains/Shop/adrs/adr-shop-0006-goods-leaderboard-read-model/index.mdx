---
id: adr-shop-0006-goods-leaderboard-read-model
name: "ADR-0006 (shop): Goods leaderboard as Kafka-driven Redis read model"
version: 1.0.0
summary: "The storefront needs a leaderboard based on real purchases, not static UI mocks."
status: accepted
date: 2026-03-11
owners:
  - shop-platform
...
x-source:
  ...
  path: docs/ADR/decisions/0006-goods-leaderboard-read-model.md
  sha256: 3e3ce7d37007df29d017434a758a0a4b5bff24fe596262df3f13d680f509f56e
---

> Source: [docs/ADR/decisions/0006-goods-leaderboard-read-model.md](https://github.com/shortlink-org/shop/blob/main/docs/ADR/decisions/0006-goods-leaderboard-read-model.md)
