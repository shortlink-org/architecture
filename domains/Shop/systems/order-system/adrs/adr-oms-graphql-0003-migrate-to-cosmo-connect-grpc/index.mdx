---
id: adr-oms-graphql-0003-migrate-to-cosmo-connect-grpc
name: "ADR-0003 (oms-graphql): Migrate To Cosmo Connect gRPC Subgraph"
version: 1.0.0
summary: "The original oms-graphql implementation used Tailcall to translate GraphQL operations into gRPC calls to oms."
status: accepted
date: 2026-03-08
owners:
  - shop-platform
...
x-source:
  ...
  path: oms-graphql/docs/ADR/decisions/0003-migrate-to-cosmo-connect-grpc.md
  sha256: 85b16edee65235e2c7401a5588f10290a996b296ceaa4291cdb185ce4b954268
---

> Source: [oms-graphql/docs/ADR/decisions/0003-migrate-to-cosmo-connect-grpc.md](https://github.com/shortlink-org/shop/blob/main/oms-graphql/docs/ADR/decisions/0003-migrate-to-cosmo-connect-grpc.md)
