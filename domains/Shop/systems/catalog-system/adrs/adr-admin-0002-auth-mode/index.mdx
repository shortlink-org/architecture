---
id: adr-admin-0002-auth-mode
name: "ADR-0002 (admin): Authentication: Oathkeeper + RemoteUser"
version: 1.0.0
summary: "We need a robust and secure authentication system for the Django admin."
status: accepted
date: 2024-03-24
owners:
  - shop-platform
...
x-source:
  ...
  path: admin/docs/ADR/decisions/0002-auth-mode.md
  sha256: 6c9451ee0147ba8ed86a0fedaddd03e0078efaf7a545339ac88188079bd988bc
---

> Source: [admin/docs/ADR/decisions/0002-auth-mode.md](https://github.com/shortlink-org/shop/blob/main/admin/docs/ADR/decisions/0002-auth-mode.md)
