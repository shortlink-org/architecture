---
id: adr-proxy-0006-permissions-api-zero-trust
name: "ADR-0006 (proxy): Permissions API for Zero-Trust Security"
version: 1.0.0
summary: TODO — one sentence. Scaffolded from upstream; condense the body and add appliesTo. The upstream date is approximate — confirm it.
status: accepted
date: 2025-01-01
owners:
  - link-platform
x-source:
  ...
  path: boundaries/proxy/docs/ADR/decisions/0006-permissions-api-zero-trust.md
  sha256: dfb675be763d771cc13236e3bc91e320b37c402745e15ed0b06bcd0e606866fb
---

> Source: [boundaries/proxy/docs/ADR/decisions/0006-permissions-api-zero-trust.md](https://github.com/shortlink-org/shortlink/blob/main/boundaries/proxy/docs/ADR/decisions/0006-permissions-api-zero-trust.md)
