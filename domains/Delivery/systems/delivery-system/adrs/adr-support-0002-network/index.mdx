---
id: adr-support-0002-network
name: "ADR-0002 (support): Network Setup for Support Service"
version: 1.0.0
summary: "Our \"Support Service\" needs a high-performance network setup to handle customer requests effectively."
status: accepted
date: 2023-06-19
owners:
  - shop-platform
...
x-source:
  ...
  path: support/docs/ADR/decisions/0002-network.md
  sha256: e3a16ef04dcba3e9a86e1e1a87a88affa7f4d107f3e1e53551ce597676260af4
---

> Source: [support/docs/ADR/decisions/0002-network.md](https://github.com/shortlink-org/shop/blob/main/support/docs/ADR/decisions/0002-network.md)
