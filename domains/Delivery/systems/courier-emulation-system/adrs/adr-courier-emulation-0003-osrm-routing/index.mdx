---
id: adr-courier-emulation-0003-osrm-routing
name: "ADR-0003 (courier-emulation): OSRM as Routing Engine"
version: 1.0.0
summary: "For courier movement emulation, we need a mechanism for generating realistic routes:"
status: accepted
date: 2025-01-30
owners:
  - shop-platform
...
x-source:
  ...
  path: courier-emulation/docs/ADR/decisions/0003-osrm-routing.md
  sha256: 4a95f0849a504bf341311feb159040338978759782390c2e3cefb1e27f552ad0
---

> Source: [courier-emulation/docs/ADR/decisions/0003-osrm-routing.md](https://github.com/shortlink-org/shop/blob/main/courier-emulation/docs/ADR/decisions/0003-osrm-routing.md)
