...
- [[adr|adr-0001-zero-trust-authentication-flow]] — move session validation out of BFF into Oathkeeper at the edge
- [[adr|adr-0002-permissions-with-spicedb]] — use SpiceDB instead of Ory Keto for permissions
- [[adr|adr-0003-access-control-schema]] — the `user` / `anonymoususer` / `team` / `link` schema
